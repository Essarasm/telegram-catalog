...
_CURRENT = os.getenv("ADMIN_API_KEY")
...
def get_admin_key() -> str:
    ...
    of hardcoding a string. Raises if `ADMIN_API_KEY` is unset."""
    if not _CURRENT:
        raise RuntimeError("ADMIN_API_KEY env var is not set")
    return _CURRENT
